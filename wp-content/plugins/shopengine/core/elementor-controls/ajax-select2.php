...
class Ajax_Select2 extends \Elementor\Base_Data_Control {
	...
	public function get_api_url(){
		return get_rest_url() . 'shopengine-builder/v1';
	}
	...
	public function enqueue() {
		// script
		wp_register_script( 'shopengine-js-ajaxchoose-control',  Init::get_url() . 'assets/js/ajaxchoose.js' );
		wp_enqueue_script( 'shopengine-js-ajaxchoose-control' );
	}
