 ...
 * @since 1.0.0
 */
class Ecommerce_Store_Elementor_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'ecommerce_store_elementor';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'ecommerce-store-elementor' ), $i ),
...
// Initialize.
$Ecommerce_Store_Elementor_Footer_Widgets = new Ecommerce_Store_Elementor_Footer_Widgets();